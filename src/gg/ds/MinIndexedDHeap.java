...
public class MinIndexedDHeap<T extends Comparable<T>> {
    ...
    public static void main(String[] args) {
        MinIndexedDHeap<Integer> priorityQueue = new MinIndexedDHeap<>(2,  5);

        priorityQueue.insert(1, 34);
        priorityQueue.insert(4, 20);
        priorityQueue.insert(2, 45);
        priorityQueue.insert(3, 60);
        priorityQueue.insert(0, 67);
